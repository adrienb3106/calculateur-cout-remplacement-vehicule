...
const fr = {
  ...
  effectiveTarget: (v) => `Total cible : ${v} €/mois`,
  targetLoanPayment: (v) => `dont mensualité prêt max : ${v} €/mois`,
...
const en = {
  ...
  effectiveTarget: (v) => `Total target: ${v} €/mo`,
  targetLoanPayment: (v) => `incl. max loan payment: ${v} €/mo`,
